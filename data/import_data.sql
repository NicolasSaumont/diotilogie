...
Alors, la prochaine fois que tu verras une vieille photo en noir et blanc de cette époque, rappelle-toi que c''était une période où le monde jouait un drôle de jeu de puzzle géant, mais qu''il en a appris des leçons précieuses pour construire un avenir plus paisible et uni.', '/img/ww1.png', 1),
