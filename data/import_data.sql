...
INSERT INTO "question" ("id", "title", "description", "image", "user_id") VALUES
...
En résumé, la couleur des cheveux est déterminée par des gènes que nous héritons de nos parents. Deux parents blonds ont plus de chances d''avoir un enfant blond parce qu''ils ont une plus grande probabilité de transmettre les allèles pour les cheveux blonds à leur enfant. Cependant, il y a des facteurs génétiques et environnementaux qui peuvent également jouer un rôle, et il existe toujours une possibilité de variations dans la couleur des cheveux en fonction de la combinaison spécifique des gènes hérités.', 'blond-family', 1),
...
En résumé, les bateaux flottent grâce au principe de la poussée d''Archimède, qui explique comment les objets immergés dans un fluide subissent une force dirigée vers le haut. Pour flotter, un bateau doit être fabriqué à partir de matériaux moins denses que l''eau, avoir une forme creuse qui augmente son volume et déplacer suffisamment d''eau pour générer une poussée d''Archimède égale ou supérieure à son poids. La conception, la forme et la répartition du poids jouent un rôle essentiel dans la flottabilité et la stabilité d''un bateau.', 'boats', 1),
...
En résumé, la boussole indique le Nord en raison de l''interaction entre l''aiguille magnétique de la boussole et le champ magnétique terrestre. Le champ magnétique est généré par les mouvements de fer liquide dans le noyau de la Terre, créant ainsi des pôles magnétiques. L''aiguille magnétique de la boussole pointe naturellement vers le Nord magnétique de la Terre en raison de cette interaction. Cela permet aux navigateurs et aux voyageurs de s''orienter en utilisant les points cardinaux.', 'compass', 1),
...
En résumé, les shérifs portaient une étoile en tant que symbole d''autorité et de responsabilité dans l''Ouest américain. L''étoile servait à reconnaître visuellement les shérifs en tant qu''autorités locales chargées de maintenir la paix, l''ordre et la sécurité. Cette tradition historique est devenue un symbole culturellement significatif et continue de faire partie de la représentation populaire du shérif dans la culture américaine.', 'sherif', 1),
...
En résumé, la galette des Rois est étroitement liée à la célébration de l''Épiphanie, qui commémore la visite des rois mages à Jésus. La galette est devenue un symbole de partage, de convivialité et de jeu, où la quête de la fève cache une touche d''excitation. Au fil des siècles, cette tradition s''est adaptée à différentes cultures et régions, mais elle demeure un moment apprécié pour se rassembler et célébrer l''esprit de l''Épiphanie.', 'kings-cake', 1),
...
5.	Règles du calendrier grégorien : Selon le calendrier grégorien, une année est considérée comme bissextile si elle est divisible par 4. Cependant, il y a une exception à cette règle : les années séculaires (années se terminant par 00) ne sont bissextiles que si elles sont également divisibles par 400. Par exemple, 1600 était bissextile car il est divisible par 400, mais 1700 n''était pas bissextile car bien qu''il soit divisible par 4, il ne l''est pas par 400.
